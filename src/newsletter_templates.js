...
export const TRIGGER_TEMPLATES = {
    ...
    UNLUCKIEST_TEAM: [
        "The Glass Cannon dilemma takes center stage in Week {week_num}, as {manager_name} squares off with {opponent_name}. While {manager_name} ranks {luck_rank} with a brutal Luck Index deficit of {luck_index} ({all_play_record} all-play vs. {actual_record} actual), the perennial debate across the league is how that fortune translates against this week's adversary. Across their series history ({opp_h2h_record}), {opp_luck_breakdown}",
        "Schedule cruelty meets a familiar opponent on Sunday, as {manager_name} battles {opponent_name}. Holding an elite all-play record of {all_play_record} ({all_play_pct}%) yet burdened with a {actual_record} actual mark, {manager_name} carries {luck_index} of unearned misfortune into Week {week_num}. Against {opponent_name} ({opp_h2h_record}), {opp_luck_breakdown}",
        "Is {manager_name} truly cursed against {opponent_name}, or will the karmic pendulum finally swing on Sunday? Entering Week {week_num} as the {luck_rank} with a Luck Index deficit of {luck_index} ({all_play_record} all-play vs. {actual_record} actual), {opp_luck_breakdown} League mates are watching closely to see if {opponent_name} can maintain their edge or if the luck finally turns.",
        "The ultimate hard-luck case study resumes on Sunday: {manager_name} takes the field against {opponent_name} holding a sterling {all_play_pct}% all-play mark ({all_play_record}), yet sitting on a {actual_record} real-world ledger ({luck_index} in lost win equity). {opp_luck_breakdown} The question for both benches is whether Sunday delivers honest regression or another chapter of heartbreak.",
        "Few topics spark more debate than {manager_name}'s historical bad beats, standing {luck_rank} with {luck_index} in lost win equity ({all_play_record} all-play vs. {actual_record} actual). But entering Week {week_num} against {opponent_name} ({opp_h2h_record}), {opp_luck_breakdown} Sunday promises to test whether the schedule curse holds up under pressure.",
        "A collision of misfortune and history: {manager_name} enters Sunday carrying a Luck Index deficit of {luck_index} ({luck_rank}), having compiled an elite {all_play_record} all-play mark against an unrewarded {actual_record} actual record. Facing {opponent_name} ({opp_h2h_record}), {opp_luck_breakdown} Sunday offers {manager_name} the stage to discover if cosmic justice is real.",
        "The debate over schedule karma reignites in Week {week_num}, as {manager_name} meets {opponent_name}. Despite dominating the broader field with an all-play record of {all_play_record} ({all_play_pct}%), {manager_name} has been handcuffed to a {actual_record} actual record ({luck_index} deficit). Against {opponent_name} ({opp_h2h_record}), {opp_luck_breakdown}",
        "All firepower, volatile fortune: {manager_name} has produced at an elite level ({all_play_pct}% all-play across {all_play_record}), but ranks {luck_rank} with {luck_index} in schedule bad breaks. In Week {week_num}, {manager_name} stares down {opponent_name} ({opp_h2h_record}): {opp_luck_breakdown} The question for both benches is whether luck finally normalizes on Sunday.",
        "Opening week brings an immediate test of cosmic justice, as {manager_name} takes on {opponent_name}. Carrying the mantle of {luck_rank}, {manager_name} has watched schedule variance steal {luck_index} from their career win column ({actual_record} actual vs. {all_play_record} all-play). With {opp_h2h_record} on the shared ledger, {opp_luck_breakdown} Sunday will show whether {manager_name} can finally catch an honest break.",
        "The Glass Cannon award winner returns to the arena: {manager_name} enters Week {week_num} with an all-play record of {all_play_record}, but a cursed actual mark of {actual_record} and a Luck Index deficit of {luck_index} ({luck_rank}). Facing {opponent_name} ({opp_h2h_record}), {opp_luck_breakdown}"
    ],
    ...
    TITLE_DEFENSE_KICKOFF: [
        ...
        "Heavy lies the crown as {champion_name} steps onto the field in Week {week_num} against {challenger_name}. Coming off a {champ_final_score} victory over {champ_runner_up} to secure the {prev_season} crown, {champion_name} begins the repeat campaign against an opponent in {challenger_name} who enters {nemesis_context}.",
        "The quest for back-to-back glory begins on Sunday for {champion_name}, colliding with {challenger_name} in an opening-week showcase. After topping {champ_runner_up} by {champ_margin} points ({champ_final_score}) in the {prev_season} title tilt, {champion_name} now faces {challenger_name} with {last_meeting_result}.",
        "Championship swagger meets opening-day reality as {champion_name} takes on {challenger_name}. Riding high from hoisting the trophy after a {champ_final_score} victory over {champ_runner_up}, {champion_name} must navigate an immediate challenge against {challenger_name}, who enters {nemesis_context}.",
        "All eyes across the league are on {champion_name} in Week {week_num}, opening the season against {challenger_name}. Months after dispatching {champ_runner_up} ({champ_final_score}) to hoist the {prev_season} trophy, {champion_name} faces a hungry challenger in {challenger_name}, with {last_meeting_result} setting the tone.",
        "Defending the title is never simple, and {champion_name} draws a battle-tested adversary in {challenger_name} for kickoff weekend. Fresh off a {champ_margin}-point triumph over {champ_runner_up} ({champ_final_score}) for the {prev_season} championship, {champion_name} battles {challenger_name} as {nemesis_context} hangs in the balance.",
        "The reign begins anew as {champion_name} squares off against {challenger_name} in Week {week_num}. Having claimed the {prev_season} title with a {champ_final_score} win over {champ_runner_up}, {champion_name} faces an immediate test against {challenger_name}, who enters {last_meeting_result} looking to spoil the celebration."
    ],
    ...
    ROOKIE_GAMBLE_RADAR: [
        "In a bold opening-day gambit, {manager_name} is inserting rookie {rookie_pos_full} {rookie_name} ({nfl_team}) directly into the starting lineup against {opponent_name}. {rookie_history_sentence} Entrusting an opening-day roster spot to an unproven first-year asset represents a high-variance wager, as {manager_name} bypasses veteran depth to chase immediate athletic upside. The league will be watching closely to see if {rookie_name} rewards the early faith on Sunday.",
        "Youth takes center stage for {manager_name} in Week {week_num}, as rookie {rookie_name} earns an immediate start against {opponent_name}. Entering his {campaign_count} fantasy campaign, {rookie_history_sentence} Making this opening-week nod for {rookie_name} represents a major tactical departure designed to catch {opponent_name} off balance.",
        "A true baptism by fire awaits rookie {rookie_name} on kickoff weekend, with {manager_name} locking the newcomer directly into the Week {week_num} lineup. {rookie_history_sentence} Bypassing proven veterans on the pine, {manager_name} is wagering that {rookie_name}'s high-octane pedigree will provide the decisive spark against {opponent_name}.",
        "High risk, explosive ceiling: {manager_name} breaks from conventional opening-day prudence by starting rookie {rookie_pos_full} {rookie_name} ({nfl_team}) against {opponent_name}. {rookie_history_sentence} While starting rookies in September introduces immense lineup volatility, {manager_name} is convinced {rookie_name} is ready for prime-time production.",
        "Pedigree over tenure: {manager_name} awards rookie sensation {rookie_name} an immediate start in Week {week_num} against {opponent_name}. {rookie_history_sentence} Choosing not to let the newcomer season on the bench, {manager_name} is banking on an explosive debut to establish early-season momentum.",
        "The rookie leap of faith is official: {manager_name} bypasses seasoned depth to start {rookie_name} ({rookie_pos_full}, {nfl_team}) against {opponent_name}. {rookie_history_sentence} Heading into his {campaign_count} season, {manager_name} signals supreme confidence in {rookie_name}'s ability to handle game-day pressure right out of the gate.",
        "Opening day arrives with a major tactical wager, as {manager_name} names rookie {rookie_name} to the starting lineup against {opponent_name}. {rookie_history_sentence} Facing an immediate test in Week {week_num}, {manager_name} is betting that raw talent and draft capital will overpower {opponent_name}'s defensive schemes.",
        "Gambling on upside from day one: {manager_name} locks rookie {rookie_name} into the starting unit against {opponent_name}. {rookie_history_sentence} Entrusting critical opening-week points to a first-year weapon is the ultimate managerial gamble, as {manager_name} seeks to out-maneuver {opponent_name} before kickoff.",
        "A dramatic statement of confidence: {manager_name} entrusts his Week {week_num} fortunes to rookie {rookie_name}. {rookie_history_sentence} With starting lineup spots at a premium, {manager_name} is betting that {rookie_name}'s athletic ceiling will deliver instant dividends against {opponent_name}.",
        "Unproven talent in prime time: {manager_name} turns heads across the league by starting rookie {rookie_name} in Week {week_num}. {rookie_history_sentence} Bypassing veteran depth to unleash the rookie against {opponent_name}, {manager_name} is betting that his draft evaluation will pay off on the Sunday scoreboard."
    ],
    ...
    WEEK1_HISTORICAL_STREAK: [
        ...
        "Few calendar trends are more confounding than {manager_name}'s opening-day struggles, having dropped {streak_len} consecutive Week 1 contests since {start_year}, {opener_history_text}. Starting {w1_record} all-time on opening day means facing {opponent_name} carries extra urgency.",
        ...
        "Can {manager_name} finally escape the opening-day trap, having dropped {streak_len} consecutive season openers dating back to {start_year}, {opener_history_text}? Facing {opponent_name} on Sunday, {manager_name} must reverse the tide or spend another season searching for answers.",
...
export const TRIGGER_HEADLINES = {
    ...
    ROOKIE_GAMBLE_RADAR: [
        "Breaking {tradition_phrase} Tradition: {manager_name} Gambles on Rookie {rookie_name}",
